...
export const translations: Dict = {
  ...
  'journal.title': 'Articles & Inspirations',
  'journal.subtitle': 'Dispatches from the world we inhabit — stories of place, taste, and the art of living deliberately.',
  ...
  'enquiry.subtitle': 'We prefer to listen before we speak. Share what moves you — a place, a feeling, a memory you wish to create — and we shall take it from there.',
  'enquiry.cta': 'Request a Consultation',

  /* ── Consultation form ── */
  'consult.label': 'Private Consultation',
  'consult.title': 'Begin the Conversation',
  'consult.subtitle': 'Share what moves you — a place, a feeling, a memory you wish to create — and we shall take it from there. Every enquiry is held in the strictest confidence.',
